...
import { OrderService } from 'app/entities/orders/order/order.service';
        ...
        const returnedFromService = Object.assign(
          {
            ...
            autoExpireDate: currentDate.format(DATE_FORMAT),
        ...
        const returnedFromService = Object.assign(
          {
            ...
            conceptUuid: 'BBBBBB',
            ordererUuid: 'BBBBBB',
            encounterUuid: 'BBBBBB',
            instructions: 'BBBBBB',
            startDate: currentDate.format(DATE_FORMAT),
            autoExpireDate: currentDate.format(DATE_FORMAT),
            discontinued: true,
            discontinuedDate: currentDate.format(DATE_FORMAT),
            accessionNumber: 'BBBBBB',
            discontinuedReasonNonCoded: 'BBBBBB',
            patientUuid: 'BBBBBB',
          },
          elemDefault
        );
