...
```
$ docker image tag gateway enyachoke/gateway
$ docker push enyachoke/gateway
$ docker image tag forms enyachoke/forms
$ docker push enyachoke/forms
$ docker image tag orders enyachoke/orders
$ docker push enyachoke/orders
$ docker image tag concepts enyachoke/concepts
$ docker push enyachoke/concepts
```
